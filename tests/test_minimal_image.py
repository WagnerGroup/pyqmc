...
def test():
    ...
    assert np.linalg.norm(diff)<1e-12, "general_dist_i and orthogonal_dist_i don't give the same answer for the lattice vectors {0}; at least one of them has an error".format(latvecs)
