...
class PGradDescriptor:
    """   """
    def __init__(self,enacc,transform,dm_evaluators,
            descriptors,nodal_cutoff=1e-5):
        """ 
...
def optimize(wf,configs,acc,objective,forcing,iters=10,tstep=0.5,npts=10,datafile=None,
