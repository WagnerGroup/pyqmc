...
class Ewald:
    ...
    def set_gpoints_gweight(self, gmax: int, tol: float = 1e-10):
        '''
    ...
    def ewald_real_weight(self, dist: gpu.cp.ndarray, lattice_displacements: gpu.cp.ndarray) -> gpu.cp.ndarray:
        ...
        :return: weight for real-space sum.
        '''
    ...
    def ewald_real_elec_ion_cross(self, configs: PeriodicConfigs):
        r'''
    ...
    def ewald_real_elec_elec_cross(self, configs: PeriodicConfigs):
        r'''
    ...
    def ewald_recip_weight(self, dist: gpu.cp.ndarray):
        r'''
        Compute the weight for the reciprocal-space sum

        .. math:: W_{\textrm{recip}}(k, z_{mn}) = \frac{\pi}{A k}
                \left[
        ...
        :returns: weight for reciprocal-space sum
        :
        '''
        z = dist[..., 2][None, ...]
    ...
    def ewald_recip_elec_ion(self, configs: PeriodicConfigs):
        r'''
    ...
    def ewald_recip_elec_elec(self, configs: PeriodicConfigs):
        r'''
        Compute ion-ion contributions to the reciprocal-space sum.
    ...
    def ewald_real_ion_ion_self(self):
        r'''
    ...
    def ewald_recip_weight_charge(self, dist: gpu.cp.ndarray) -> gpu.cp.ndarray:
        ...
        :parameter dist: distance matrix.
            Shape: (num_particles_m, num_particles_n, 3) or (nconf, num_particles_m, num_particles_n, 3)
        :return: Shape: (num_particles_m, num_particles_n) or (nconf, num_particles_m, num_particles_n)
        '''
