...
def run_test():
    mol = pyscf.gto.M(atom = "O 0. 0. 0.; H 0. 0. 2.0", basis='ccecpccpvtz', ecp='ccecp', unit='bohr', charge=-1)
    ...
    data, configs = pyqmc.vmc(wf, configs, nblocks=40, verbose=True, accumulators={'energy':pyqmc.EnergyAccumulator(mol)} )
